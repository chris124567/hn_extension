 ...
 *
 * GUIDELINES in rule-classifier/src/prompt.rs is the source of truth; copy the
 * text verbatim from there. These strings drifted from it once already, which is
 * how a rule the teacher never applied ended up described to users.
 */
